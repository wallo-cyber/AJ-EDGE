...
const EXTERNAL_SEARCH_PAUSED_AGENTS = new Set<AgentName>(['Verification', 'Enrichment', 'Decision Maker', 'Vendor Registration', 'Discovery adapter']);
const EXTERNAL_SEARCH_PAUSED_MESSAGE = 'PAUSED — EXTERNAL SEARCH UNAVAILABLE';
