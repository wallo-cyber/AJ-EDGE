...
const secondaryGroups = [
  { label: 'العلاقات والتواصل', links: [['/email-center', 'الإيميلات'], ['/marketing', 'فريق التسويق'], ['/vendors', 'الموردون'],['/contacts', 'جهات الاتصال'], ['/labor', 'العمالة'], ['/prices', 'أسعار المواد'], ['/materials-catalog', 'دليل البنود'], ['/research', 'البحث والتحقق']] },
