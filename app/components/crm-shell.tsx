...
export function CRMPage({ title, description, action, children }: Props) {
  ...
  return <div className="min-h-screen text-[#2f2417]">
    <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[#e7d8b8] bg-[#fffdf9]/95 px-4 py-3 backdrop-blur lg:hidden">
      <div><strong>ALGAEU</strong><span className="mr-2 text-xs text-[#8a6f35]">تطوير الأعمال</span></div>
      <button className="btn-ghost" aria-label="فتح القائمة" onClick={() => setOpen(!open)}>{open ? 'إغلاق' : 'القائمة'}</button>
    </header>
    <div className="mx-auto flex max-w-[1680px] gap-4 px-3 py-4 sm:px-5 lg:px-6 lg:py-5">
      ...
      <aside className={`${open ? 'translate-x-0' : 'translate-x-full'} ${collapsed ? 'lg:w-[78px]' : 'lg:w-60'} fixed inset-y-0 right-0 z-50 w-[286px] overflow-y-auto border-l border-[#e8d9b7] bg-[#fffdf9] p-3 shadow-2xl transition-[width,transform] lg:sticky lg:top-5 lg:z-auto lg:h-[calc(100vh-2.5rem)] lg:translate-x-0 lg:rounded-3xl lg:border` }>
        ...
        <div className="mb-4 rounded-2xl bg-[#2f2417] p-4 text-[#fff8e8]">
        ...
        {!collapsed && <details className="mt-3 rounded-xl border border-[#eadfc9] p-2" open><summary className="cursor-pointer px-2 text-xs font-bold text-[#9a7b2f]">تطوير الأعمال</summary><div className="mt-2 space-y-1 text-xs"><Link href="/companies" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">جميع الشركات</Link><Link href="/company-segments/developers" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المطورون العقاريون</Link><Link href="/company-segments/factories" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المصانع</Link><Link href="/company-segments/industrial" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الشركات الصناعية</Link><Link href="/company-segments/main-contractors" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المقاولون الرئيسيون</Link><Link href="/company-segments/consultants" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الاستشاريون الهندسيون</Link><Link href="/company-segments/owners" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">ملاك المشاريع</Link><Link href="/company-segments/partners" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الموردون والشركاء</Link><Link href="/opportunity-radar" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">Opportunity Radar</Link><Link href="/campaigns" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الحملات</Link></div></details>}
        {!collapsed && <details className="mt-3 rounded-xl border border-[#eadfc9] p-2"><summary className="cursor-pointer px-2 text-xs font-bold text-[#9a7b2f]">المحتوى</summary><Link href="/sales-kit" className="mt-2 block rounded-lg px-2 py-1 text-xs hover:bg-[#f5ecdb]">Sales Kit</Link></details>}
      ...
      <main className="min-w-0 flex-1 rounded-3xl border border-[#e8d9b7] bg-[#fffdf9]/92 p-4 shadow-[0_16px_45px_rgba(70,48,18,.06)] sm:p-5 lg:p-6">
