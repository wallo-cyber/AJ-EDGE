  ...
  return <div className="min-h-screen text-[#2f2417]">
    ...
    <div className="mx-auto flex max-w-[1680px] gap-4 px-3 py-4 sm:px-5 lg:px-6 lg:py-5">
      ...
      <aside className={`${open ? 'translate-x-0' : 'translate-x-full'} ${collapsed ? 'lg:w-[78px]' : 'lg:w-60'} fixed inset-y-0 right-0 z-50 w-[286px] overflow-y-auto border-l border-[#e8d9b7] bg-[#fffdf9] p-3 shadow-2xl transition-[width,transform] lg:sticky lg:top-5 lg:z-auto lg:h-[calc(100vh-2.5rem)] lg:translate-x-0 lg:rounded-3xl lg:border` }>
        ...
        {!collapsed && <details className="mt-3 rounded-xl border border-[#eadfc9] p-2" open><summary className="cursor-pointer px-2 text-xs font-bold text-[#9a7b2f]">تطوير الأعمال</summary><div className="mt-2 space-y-1 text-xs"><Link href="/companies" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">جميع الشركات</Link><Link href="/companies?segment=developer" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المطورون العقاريون</Link><Link href="/companies?segment=factory" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المصانع</Link><Link href="/companies?segment=industrial" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الشركات الصناعية</Link><Link href="/companies?segment=contractor" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">المقاولون الرئيسيون</Link><Link href="/companies?segment=consultant" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الاستشاريون</Link><Link href="/companies?segment=owner" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">ملاك المشاريع</Link><Link href="/opportunity-radar" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">Opportunity Radar</Link><Link href="/campaigns" className="block rounded-lg px-2 py-1 hover:bg-[#f5ecdb]">الحملات</Link></div></details>}
