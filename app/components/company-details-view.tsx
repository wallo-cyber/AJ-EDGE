...
type CompanyTab = 'overview' | 'intelligence' | 'contacts' | 'research' | 'signals' | 'outreach' | 'relationship' | 'pipeline' | 'activity' | 'decisionMakers' | 'vendorRegistration' | 'followups' | 'meetings' | 'opportunities';
const companyTabs: { id: CompanyTab; label: string }[] = [
  ...
  { id: 'research', label: 'البحث' }, { id: 'signals', label: 'الإشارات والمشاريع' }, { id: 'outreach', label: 'التواصل' }, { id: 'relationship', label: 'العلاقة' },
