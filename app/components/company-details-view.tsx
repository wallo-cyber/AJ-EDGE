...
type CompanyTab = 'overview' | 'intelligence' | 'contacts' | 'research' | 'outreach' | 'relationship' | 'pipeline' | 'activity' | 'decisionMakers' | 'vendorRegistration' | 'followups' | 'meetings' | 'opportunities';
