...
when t.template_name='Short WhatsApp' then 'السلام عليكم، نتواصل من نوفافيرك للتعارف مع '||c.company_name||' وبحث فرص تعاون مناسبة في أعمال المقاولات والتنفيذ. نأمل توجيهنا لمسؤول المشاريع أو المشتريات.'
